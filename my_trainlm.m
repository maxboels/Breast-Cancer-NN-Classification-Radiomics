function [trainlm_ensemble_avg_errors, testlm_ensemble_avg_errors] = my_trainlm(x, t, classifiers, nodes, epochs)
    N = 10;
    trainFcn = 'trainlm';
    ...
    for c = 1:length(classifiers)
        ...
        trainlm_ensemble_avg_errors(c) = mean(train_ensemble_errors);
        testlm_ensemble_avg_errors(c) = mean(test_ensemble_errors);
    end
